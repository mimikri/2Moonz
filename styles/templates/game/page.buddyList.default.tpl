...
<tr>
	...
	<td><a href="game.php?page=buddyList&amp;mode=accept&amp;id={$otherRequestID}"><img src="styles/resource/images/true.webp" alt="{$LNG.bu_accept}" title="{$LNG.bu_accept}"></a><a href="game.php?page=buddyList&amp;mode=delete&amp;id={$otherRequestID}"><img src="styles/resource/images/false.webp" alt="{$LNG.bu_decline}" title="{$LNG.bu_decline}"></a></td>
</tr>
{foreachelse}
...
<tr>
	...
	<td><a href="game.php?page=buddyList&amp;mode=delete&amp;id={$myRequestID}"><img src="styles/resource/images/false.webp" alt="{$LNG.bu_cancel_request}" title="{$LNG.bu_cancel_request}"></a></td>
</tr>
{foreachelse}
<tr><td colspan="5">{$LNG.bu_no_request}</td></tr>
{/foreach}
...
<tr>
	...
	<td><a href="game.php?page=buddyList&amp;mode=delete&amp;id={$myBuddyID}"><img src="styles/resource/images/false.webp" alt="{$LNG.bu_delete}" title="{$LNG.bu_delete}"></a></td>
</tr>
{foreachelse}
