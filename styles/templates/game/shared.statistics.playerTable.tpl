...
<tr>
	...
	<td>{if $RangeInfo.id != $CUser_id}<a href="#" onclick="return Dialog.PM({$RangeInfo.id});"><img src="{$dpath}img/m.webp" title="{$LNG.st_write_message}" alt="{$LNG.st_write_message}"></a>{/if}</td>
