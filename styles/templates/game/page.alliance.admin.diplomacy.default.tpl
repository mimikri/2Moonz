...
<p>
	...
	<tr>
		...
		<tr>
			...
			<td>
				<a href="game.php?page=alliance&amp;mode=admin&amp;action=diplomacyDelete&amp;id={$diploID}" onclick="return confirm('{$LNG.al_diplo_confirm_delete}');"><img src="styles/resource/images/false.webp" alt="" width="16" height="16"></a>
			</td>
		</tr>
		{foreachelse}
		<tr>
...
<p>
	...
	{if array_filter($diploList.1)}
		...
		<tr>
			<td style="width:90%">{$diploName}</td>
			<td>
				<a href="game.php?page=alliance&amp;mode=admin&amp;action=diplomacyAccept&amp;id={$diploID}" onclick="return confirm('{$LNG.al_diplo_accept_yes_confirm}');"><img src="styles/resource/images/true.webp" alt="" width="16" height="16"></a>
				<a href="game.php?page=alliance&amp;mode=admin&amp;action=diplomacyDelete&amp;id={$diploID}" onclick="return confirm('{$LNG.al_diplo_accept_no_confirm}');"><img src="styles/resource/images/false.webp" alt="" width="16" height="16"></a>
			</td>
		</tr>
		{/foreach}
		{/if}
