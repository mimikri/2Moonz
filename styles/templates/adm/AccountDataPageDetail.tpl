...
;}
table.tableunique{
border:0px;background:url(./styles/resource/images/admin/blank.webp);width:100%;
}
td.unico{
...
td.blank{
border:0px;background:url(./styles/resource/images/admin/blank.webp);text-align:right;padding-right:80px;font-size:15px;
}
</style>
...
<table class="tableunique">
	<tr>
		<td class="blank"><a class="tooltip" data-tooltip-content="{$ac_note_k}">{$ac_leyend}&nbsp; <img src="./styles/resource/images/admin/i.webp" height="12" width="12"></a></td>
	</tr>
	<tr>
		<td class="unico transparent"><a href="#" onclick="$('#datos').slideToggle();return false" class="link">
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$ac_account_data}</a></td>
	</tr><tr>
		...
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$ac_id_names_coords}</a></td>
	</tr><tr>
		<td class="unico transparent">
		...
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$resources_title}</a></td>
	</tr><tr>
		<td class="unico transparent">
		...
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$buildings_title}</a></td>
	</tr><tr>
		<td class="unico transparent">
		...
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$ships_title}</a></td>
	</tr><tr>
		<td class="unico transparent">
		...
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$defenses_title}</a></td>
	</tr><tr>
		<td class="unico transparent">
		...
		<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$ac_officier_research}</a></td>
	</tr><tr>
		<td class="unico transparent">
		...
		<td class="unico transparent">
			...
			<img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> {$ac_recent_destroyed_planets}</a>
			{else}<span class="no_moon"><img src="./styles/resource/images/admin/arrowright.webp" width="16" height="10"> 
