...
<tr>
	...
	<td><a href="admin.php?page=cronjob&amp;action=detail&amp;id={$CronjobInfo.id}"><img src="./styles/resource/images/admin/GO.webp"></a></td>
	<td><a href="admin.php?page=cronjob&amp;action=delete&amp;id={$CronjobInfo.id}"><img src="./styles/resource/images/false.webp" width="16" height="16"></a></td>
</tr>
{/foreach}
<tr>
