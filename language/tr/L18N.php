...
//SERVER GENERALS
$LNG['dir']         	= 'ltr';
$LNG['week_day']		= ['Pazar', 'Pazartesi', 'Sali', 'Carsamba', 'Persembe', 'Cuma', 'Cumartesi']; # Start with Sun!
$LNG['months']			= ['Ocak', 'Subat', 'Mart', 'Nisan', 'Mayis', 'Haziran', 'Temmuz', 'Agustos', 'Eylul', 'Ekim', 'Kasim', 'Aralik'];
